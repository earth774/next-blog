...
const NavLinkBlog = dynamic(() => import("@/app/components/NavLinkBlog"), {
  ssr: false,
});
  ...
  return (
    <nav className="flex flex-col sm:flex-row justify-center sm:justify-between items-center sm:items-start gap-4">
      <ul className="flex gap-6">
        ...
        <li>
          <NavLinkBlog
            href="/blog"
            text="Blog"
            className={`${pathname === "/blog" ? "bg-[#FFD700]" : ""}`}
          />
        </li>
        <li>
          <NavLinkBlog
            href="/project"
            text="Project"
            className={`${pathname === "/project" ? "bg-[#FFD700]" : ""}`}
          />
        </li>
        <li>
          <NavLinkBlog
            href="/about"
            text="About"
            className={`${pathname === "/about" ? "bg-[#FFD700]" : ""}`}
          />
        </li>
        <li>
          <a
      ...
      <div className="flex gap-4 ">
        <Link
          href="https://github.com/earth774"
          target="_blank"
          aria-label="GitHub"
        >
        ...
        <Link
          href="https://www.linkedin.com/in/sutthipong-nuanma-899389133/"
          target="_blank"
          aria-label="LinkedIn"
        >
          <svg viewBox="0 0 24 24" className="h-5 w-5 text-gray-700">
